...
export class StakeholdersService {
  ...
  create(data: { name: string; email?: string; role?: string; notes?: string; projectId?: string; companyId?: string }) {
    return this.prisma.stakeholder.create({ data });
  }

  async update(id: string, data: { name?: string; email?: string; role?: string; notes?: string }) {
