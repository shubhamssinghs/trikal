...
async function main() {
  ...
  const skills = [
    ...
    },
    {
      ...
      instructions: "To prepare for a meeting: 1) call list_upcoming_meetings to find the next meeting (or the one the user named) — note its title, time, and attendees. 2) call search_project_knowledge for that meeting's topic and attendees to surface what was discussed previously, decisions made, and open action items. 3) Produce a concise prep brief: when/who, recap of the last related meeting, open items to follow up, and 3-5 suggested talking points or an agenda. Be specific and grounded in the knowledge base.",
